import { Pressable, StyleSheet, View, Text, Alert, ActivityIndicator, Image } from "react-native";
import { LinearGradient } from 'expo-linear-gradient';
import PriceFormat from "../../../utils/priceFormat";
import IconoTipoGasto from "./IconoTipoGasto";
...
export default function ModalResumeMes({ setModalVisible, gastosSeparados, numeroGastosSeparados, car }) {
  ...
  return (
    <Pressable onPress={() => setModalVisible(false)} style={styles.centeredView}>
      ...
      >
        <View>
          <Text style={{ fontSize: 22, color: 'white', fontWeight: 'bold' }}>Hola Miguel!</Text>
